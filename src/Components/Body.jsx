...
const Body = () => {
   ...
   // const url = 'http://127.0.0.1:8000/mintRandom'
    const[image,setImage] = useState(egg)
    const[change,setChange] = useState(false)
    const[mintedIDs,setMintedIDs] = useState()
    const[mintedTamago,setMintedTamago]=useState()

    const nftAddress = '0xaAcCEE2F175f736380C8eBc4521487Bd6292CF39'
    const traitAddress = '0xF18A7840a516E2CD1A5E4c8452F8f78dC2081912'
        ...
        axios.post(url,body,{headers:{"Content-Type": "multipart/form-data"}}).then(async(response)=>{
            if(response.status===200){
                ...
                if(result['status']===1){
                    ...
                    setMintedTamago(await getTotalSupply()-1)
                    setChange(true)
                }
                else{
...
return(
    ...
    <Demo mintedTamago={mintedTamago} tokenIDs={mintedIDs}/>
    }
    </>
);
}
